...
!(function (t, e) {
	...
	function ne(t) {
		for (
			var e = Bt(t), i = ie(t);
			i && Zt(i) && "static" === Jt(i).position;

		)
			i = ie(i);
		return i &&
			("html" === Wt(i) ||
				("body" === Wt(i) && "static" === Jt(i).position))
			? e
			: i ||
					(function (t) {
						var e =
	...
	class Si extends z {
		...
		show(t) {
			this._isShown ||
				...
				P.trigger(this._element, Ci, { relatedTarget: t })
					.defaultPrevented ||
				((this._isShown = !0),
				(this._isTransitioning = !0),
	...
	const Fi = new Set([
		...
		qi = (t, e) => {
			...
			return e.includes(i)
				? !Fi.has(i) ||
						Boolean(zi.test(t.nodeValue) || Ri.test(t.nodeValue))
